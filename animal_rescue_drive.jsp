...
<title>ANIMAL RESCUE DRIVE</title>
<style>
     body {
...
<h1 class="h1">ANIMAL RESCUE DRIVE DATA</h1>
...
<%
	...
	PreparedStatement ps = con.prepareStatement("SELECT Name, Email, Phone_number, Message, response_time FROM animal_rescue_drive");
...
btn.addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'ANIMAL_RESCUE_DRIVE_DATA.pdf',  
