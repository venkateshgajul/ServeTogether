...
<h1 class="h1">REVIEW RESPONSE DATA</h1>
...
<%
	...
	PreparedStatement ps=con.prepareStatement("select Name, Email, Message, rating, response_time from review_msg");
...
btn.addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'REVIEW_RESPONSE_DATA.pdf',  
