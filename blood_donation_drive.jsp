...
<h1 class="h1">BLOOD DONATION DRIVE DATA</h1>
...
<%
	...
	PreparedStatement ps = con.prepareStatement("SELECT Name, Email, Phone_number, Message, response_time FROM blood_donation_drive");
...
btn.addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'BLOOD_DONATION_DRIVE_DATA.pdf',  
