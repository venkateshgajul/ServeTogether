...
<title>TREE PLANTATION DRIVE</title>
<style>
     body {
...
<h1 class="h1">TREE PLANTATION DRIVE DATA</h1>
...
<%
	...
	PreparedStatement ps = con.prepareStatement("SELECT Name, Email, Phone_number, Message, response_time FROM tree_plantation_drive");
...
btn.addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'TREE_PLANTATION_DRIVE_DATA.pdf',  
