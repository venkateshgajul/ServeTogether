...
<h1 class="h1">CLOTHING DRIVE DATA</h1>
...
<%
	...
	PreparedStatement ps = con.prepareStatement("SELECT Name, Email, Phone_number, Message, response_time FROM clothing_drive");
...
btn.addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'CLOTHING_DRIVE_DATA.pdf',  
