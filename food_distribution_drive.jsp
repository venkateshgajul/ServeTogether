...
<title>FOOD DISTRIBUTION DRIVE</title>
<style>
     body {
...
<h1 class="h1">FOOD DISTRIBUTION DRIVE DATA</h1>
...
<%
	...
	PreparedStatement ps = con.prepareStatement("SELECT Name, Email, Phone_number, Message, response_time FROM food_distribution_drive");
...
btn.addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'FOOD_DISTRIBUTION_DRIVE_DATA.pdf',  
