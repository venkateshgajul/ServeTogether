...
<title>Volunteer Referral Form</title>
<style>
     body {
...
<h1 class="h1">VOLUNTEER REFERRAL DATA</h1>
...
<%
	...
	PreparedStatement ps=con.prepareStatement("select name, Gender, Email, AvailabilityWeekends, AvailabilityDays, PreferredDatee, PreferredLocation, response_time from referral");
	ResultSet rs=ps.executeQuery();
	
	out.println("<table id='responseTable'>");
    out.println("<thead><tr>");
    out.println("<th>Name of Volunteer</th>");
    out.println("<th>Gender</th>");
    out.println("<th>Email</th>");
    out.println("<th>Availability on Weekends</th>");
    out.println("<th>Availability on Days</th>");
    out.println("<th>Preferred Date</th>");
    out.println("<th>Preferred Location</th>");
	...
	while(rs.next())
	{
         ...
         out.println("<td>" + rs.getString("AvailabilityWeekends") + "</td>");
         out.println("<td>" + rs.getString("AvailabilityDays") + "</td>");
         out.println("<td>" + rs.getString("PreferredDatee") + "</td>");
         out.println("<td>" + rs.getString("PreferredLocation") + "</td>");
...
btn.addEventListener('click', () => {
    ...
    const opt = {
        ...
        filename: 'VOLUNTEER_REFERRAL_DATA.pdf',  
